...
public class CropImageView extends FrameLayout {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mBitmap != null) {
            final Rect bitmapRect = ImageViewUtil
                    .getBitmapRectCenterInside(mBitmap, this);
        ...
        if (mBitmap != null) {
            ...
            if (viewToBitmapWidthRatio != Double.POSITIVE_INFINITY
                ...
                if (viewToBitmapWidthRatio <= viewToBitmapHeightRatio) {
                    ...
                    desiredHeight = (int) (mBitmap.getHeight()
                            * viewToBitmapWidthRatio);
                } else {
                    desiredHeight = heightSize;
                    desiredWidth = (int) (mBitmap.getWidth()
            ...
            int height = getOnMeasureSpec(heightMode, heightSize,
                    desiredHeight);
            ...
            final Rect bitmapRect = ImageViewUtil.getBitmapRectCenterInside(
                    mBitmap.getWidth(), mBitmap.getHeight(), mLayoutWidth,
                    mLayoutHeight);
            mCropOverlayView.setBitmapRect(bitmapRect);
    ...
    public Bitmap getCroppedImage() {
        ...
        final Rect displayedImageRect = ImageViewUtil
                .getBitmapRectCenterInside(mBitmap, mImageView);
        ...
        final Bitmap croppedBitmap = Bitmap.createBitmap(mBitmap,
                Math.abs((int) actualCropX), Math.abs((int) actualCropY),
    ...
    public RectF getActualCropRect() {
        ...
        float actualCropRight = actualCropLeft
                + displayedCropWidth * scaleFactorWidth;
        float actualCropBottom = actualCropTop
                + displayedCropHeight * scaleFactorHeight;
    ...
    private void init(Context context) {
        ...
        mCropOverlayView.setInitialAttributeValues(mGuidelines, mFixAspectRatio,
