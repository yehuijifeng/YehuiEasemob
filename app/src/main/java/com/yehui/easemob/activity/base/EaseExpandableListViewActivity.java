 ...
 * 多级列表代理类
 */
public abstract class EaseExpandableListViewActivity extends EasemobActivity {
    ...
    protected void initView() {
        mExpandableView = (MyExpandableView) findViewById(com.yehui.utils.R.id.my_expandable_view);
    ...
    class ExpandableAdapter extends BaseExpandableAdapter {
        ...
        public BaseExpandableViewHolder groupViewHolder(View parent, int groupPosition, boolean isExpanded) {
            return EaseExpandableListViewActivity.this.getGroupViewHolder(parent, groupPosition, isExpanded);
        }

        @Override
        public int groupViewByLayout() {
            return EaseExpandableListViewActivity.this.groupViewByLayout();
        }

        @Override
        public void groupItemData(BaseExpandableViewHolder baseViewHolder, int groupPosition, boolean isExpanded) {
            EaseExpandableListViewActivity.this.groupItemData(baseViewHolder, groupPosition, isExpanded);
        }

        @Override
        public BaseExpandableViewHolder childViewHolder(View parent, int groupPosition, int childPosition) {
            return EaseExpandableListViewActivity.this.getChildViewHolder(parent, groupPosition, childPosition);
        }


        @Override
        public int childViewByLayout() {
            return EaseExpandableListViewActivity.this.childViewByLayout();
        }

        @Override
        public void childItemData(BaseExpandableViewHolder baseViewHolder, int groupPosition, int childPosition) {
            EaseExpandableListViewActivity.this.childItemData(baseViewHolder, groupPosition, childPosition);
        }
