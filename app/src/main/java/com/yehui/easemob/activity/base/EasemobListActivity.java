 ...
 * listview的activity
 */
public abstract class EasemobListActivity extends EasemobActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public class MyAdapter extends BaseAdapter<Object> {
        ...
        public BaseViewHolder getViewHolder(View view) {
            return EasemobListActivity.this.getViewHolder(view, -1);
        }
        ...
        public BaseViewHolder onCreateViewHolderItem(ViewGroup parent, int viewType) {
            ...
            return EasemobListActivity.this.getViewHolder(itemView, viewType);
        }
        ...
        public int getItemType(int position) {
            return EasemobListActivity.this.getItemType(position);
        }
    }
