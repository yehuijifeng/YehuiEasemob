...
public abstract class BaseExpandableListViewFragment extends BaseFragment {
    ...
    protected void initView(View parentView) {
        mExpandableView = (MyExpandableView) parentView.findViewById(R.id.my_expandable_view);
        expandableListView = mExpandableView.expandableListView;
        mExpandableAdapter = new ExpandableAdapter(parentActivity, groupData, childData);
    ...
    class ExpandableAdapter extends BaseExpandableAdapter {
        ...
        public BaseExpandableViewHolder groupViewHolder(View parent, int groupPosition, boolean isExpanded) {
            return BaseExpandableListViewFragment.this.getGroupViewHolder(parent, groupPosition, isExpanded);
        }
        ...
        public void groupItemData(BaseExpandableViewHolder baseViewHolder, int groupPosition, boolean isExpanded) {
            BaseExpandableListViewFragment.this.groupItemData(baseViewHolder, groupPosition, isExpanded);
        }

        @Override
        public BaseExpandableViewHolder childViewHolder(View parent, int groupPosition, int childPosition) {
            return BaseExpandableListViewFragment.this.getChildViewHolder(parent, groupPosition, childPosition);
        }
        ...
        public void childItemData(BaseExpandableViewHolder baseViewHolder, int groupPosition, int childPosition) {
            BaseExpandableListViewFragment.this.childItemData(baseViewHolder, groupPosition, childPosition);
        }
